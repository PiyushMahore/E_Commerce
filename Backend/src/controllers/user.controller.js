...
const addAddress = asyncHandler(async (req, res) => {
    ...
    if (!address || !userId) {
        throw new apiError(400, "Address & User Id is required");
    }
...
const addCity = asyncHandler(async (req, res) => {
    ...
    if (!city || !userId) {
        throw new apiError(400, "city & User Id is required");
    }
    ...
    return res
        .status(200)
        .json(new apiResponse(200, user, "city Added Successfully."));
});

const addZipCode = asyncHandler(async (req, res) => {
    const { userId } = req.params;
    const { zipCode } = req.body;

    if (!zipCode || !userId) {
        throw new apiError(400, "zipCode & User Id is required");
    }
    ...
    return res
        .status(200)
        .json(new apiResponse(200, user, "zipCode Added Successfully."));
});

export { signUp, login, getCurrentUser, logOut, addAddress, addCity, addZipCode };