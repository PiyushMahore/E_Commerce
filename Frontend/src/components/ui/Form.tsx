    ...
    return (
        <div className="grid justify-items-center py-16 gap-4 text-[#283b53]">
            ...
            <div className="grid gap-4 py-3 justify-items-center xl:w-[27%] px-4">
                ...
                <Button onClick={() => auth?.signUp(firstName, lastName, email, password)} className="w-full rounded-none py-6 bg-[#283b53] hover:bg-[#3b506e] transition-colors ease-in-out duration-300">Create my account</Button>
